<nav x-data="{ open: false }" class="bg-gray-800">
    <div class="mx-auto max-w-7xl px-2 sm:px-6 lg:px-8">
        <div class="relative flex h-16 items-center justify-between">
            ...
            <div class="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start">
                ...
                <div class="hidden sm:ml-6 sm:block">
                    <div class="flex space-x-4">
                        ...
                        {{-- EL LINK "ARTICULOS" DEBE DE CONTENER LOS LINKS "ACCESORIOS", "BIJOUTERIES" Y "LENCERIAS", como si fuera un modal --}}
                        <a href="{{ Route('articulos.index') }}" class="text-gray-300 hover:bg-gray-700 hover:text-white rounded-md px-3 py-2 text-sm font-medium">Articulos</a>
                        <a href="{{ Route('accesorios.index') }}" class="text-gray-300 hover:bg-gray-700 hover:text-white rounded-md px-3 py-2 text-sm font-medium">Accesorios</a>
                        <a href="{{ Route('bijouteries.index') }}" class="text-gray-300 hover:bg-gray-700 hover:text-white rounded-md px-3 py-2 text-sm font-medium">Bijouteries</a>
                        <a href="{{ Route('lencerias.index') }}" class="text-gray-300 hover:bg-gray-700 hover:text-white rounded-md px-3 py-2 text-sm font-medium">Lencerias</a>


                        {{-- @foreach ($articulos as $articulo) --}}
                            {{-- <a href="#" class="text-gray-300 hover:bg-gray-700 hover:text-white rounded-md px-3 py-2 text-sm font-medium">{{ $articulo->nombre}}</a> --}}
                        {{-- @endforeach --}}
            ...
            @auth
                {{-- Contenido que se muestra cuando el usuario inicio sesión --}}
            ...
            @else
                {{-- Contenido que se muestra cuando el usuario no inicio sesión --}}
                <div>

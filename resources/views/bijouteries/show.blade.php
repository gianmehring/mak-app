<x-app-layout>
    ...
    <div class="container"> <!-- Container -->
        <h1 class="text-lg text-rose-700 font-bold">{{ $bijouterie->articulo->nombre }}</h1>

        <div class="bg-slate-200">
            <span class="text-sm text-red-900 font-bold">{{ $bijouterie->bijouterie }}</span>
            <h2 class="text-sm text-purple-700">{{ $bijouterie->articulo->descripcion }}</h2>
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div class="md:col-span-2">
                <!-- figure -->
                <figure>
                    <img class="w-full h-80 object-cover object-center" src="{{ Storage::url($bijouterie->foto->url) }}" alt="">
                </figure>
